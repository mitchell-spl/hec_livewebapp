    ...
    <div className="w-[100%] px-3 py-2">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col gap-5">
          ...
          <button
            disabled={loading}
            className="w-[100%] rounded-md text-white h-[48px] text-[18px] bg-cyan-400 flex items-center justify-center cursor-pointer hover:opacity-80 transition-all duration-150 ease-in-out"
          >
